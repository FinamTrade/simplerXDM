...
t=s(b);w(i,"message",e);var h=/[\-\w]+\/\.\.\//,b=b.replace(/([^:])\/\//g,"$1/");if(!b.match(/^(http||https):\/\//)){var d="/"===b.substring(0,1)?"":r.pathname;"/"!==d.substring(d.length-1)&&(d=d.substring(0,d.lastIndexOf("/")+1));b=r.protocol+"//"+r.host+d+b}for(;h.test(b);)b=b.replace(h,"");var h=q({xdm_e:s(r.href),xdm_c:j},a.params||{}),g,d="",n=b.indexOf("#");-1!=n&&(d=b.substring(n),b=b.substring(0,n));n=[];for(g in h)h.hasOwnProperty(g)&&n.push(g+"="+encodeURIComponent(h[g]));g=b+(-1==b.indexOf("?")?
